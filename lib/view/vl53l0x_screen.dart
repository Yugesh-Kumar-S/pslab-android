...
import 'package:pslab/providers/vl53l0x_provider.dart';
...
class VL53L0XScreen extends StatefulWidget {
  const VL53L0XScreen({super.key});
  @override
  State<VL53L0XScreen> createState() => _VL53L0XScreenState();
}
...
class _VL53L0XScreenState extends State<VL53L0XScreen> {
  ...
  late VL53L0XProvider _provider;
  @override
  void initState() {
    super.initState();
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SensorChartWidget(
                          title:
                              '${appLocalizations.plot} - ${appLocalizations.distance}',
                          yAxisLabel:
                              '${appLocalizations.distance} (${appLocalizations.distanceUnitLabel})',
                          lineColor: primaryRed,
                          data: provider.distanceData,
                          unit: ' ${appLocalizations.distanceUnitLabel}',
  ...
  Widget _buildRawDataSection(VL53L0XProvider provider) {
    return Container(
