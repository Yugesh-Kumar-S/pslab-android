...
const Color chartLineColor = Colors.cyan;
...
Color sensorStatusBackgroundColor = Colors.grey[100]!;
Color sensorStatusBorder = Colors.grey[300]!;
Color sensorControlsTextBox = Colors.grey.shade400;
